...
//using MediatR;
//using NetworkScanner.Service.Pong.ExceptionHandler;
//using System.Linq;
...
//            try
//            {
//                await mediator.Send(new ExceptionHandler.PingResourceTimeout { Message = "Ping to ISS resource (preferred)" });
//                isHanledCorrectly = IsExceptionHandledBy<TaskCanceledException, ExceptionHandler.CommonExceptionHandler>(writer);
//            }
//            catch (Exception e)
//            {
//                await writer.WriteLineAsync(e.Message);
...
//                isHanledCorrectly = IsExceptionHandledBy<ServerException, ExceptionHandler.ServerExceptionHandler>(writer);
//            }
//            catch (Exception e)
//            {
//                await writer.WriteLineAsync(e.Message);
